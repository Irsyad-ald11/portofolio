...
export const listProyek = [
  {
    ...
    subtitle: "A modern educational platform built with HTML, CSS, and JavaScript....",
    fullDescription:"A modern educational platform built with HTML, CSS, and JavaScript. This responsive website focuses on providing a seamless user experience for students, teachers, and parents to access school information and academic resources.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/Irsyad-ald11",
    dad: "100",
  },
  {
    id: 2,
  ...
  },
  {
    id: 3,
    image: Proyek3,
    title: "Website Responsive dengan ReactJs, TailwindCss",
    subtitle: "An project developed to Website measure and monitor...",
